...
struct program_resources {
    ...
    std::unordered_map<std::string_view, std::map<std::size_t, visible_function>> function_overloads;    // el std::size_t es el número de parámetros de la función
                                                                                                         // esto en realidad se usará para la parte de la generación de código
                                                                                                         // que en un proyecto normal de gente decente, es lo que seguiría del semántico
};
